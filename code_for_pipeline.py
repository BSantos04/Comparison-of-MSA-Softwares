...
def create_table(sp_scores, memories, times, cpus, o_scores):
    ...
    d = {
         "MSA Software": ["MAFFT", "MUSCLE", "PRANK", "ClustalOmega"],
         "SP-Score": sp_list,
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        ...
        all_memories = {"MAFFT": [], "MUSCLE": [], "PRANK": [], "ClustalOmega": []}
        all_times = {"MAFFT": [], "MUSCLE": [], "PRANK": [], "ClustalOmega": []}
        all_cpus = {"MAFFT": [], "MUSCLE": [], "PRANK": [], "ClustalOmega": []}
        all_sp_scores = {"MAFFT": [], "MUSCLE": [], "PRANK": [], "ClustalOmega": []}
